...
import dev.abdelrahman.movies.Models.User.DTOs.JwtResponse;
import dev.abdelrahman.movies.Services.AuthService;
import dev.abdelrahman.movies.Utils.MessageResponse;
import dev.abdelrahman.movies.Utils.JwtUtils;
...
public class authController {
    ...
    public ResponseEntity<?> signin(@Valid @RequestBody SigninDTO signinDTO) {
        ...
        return ResponseEntity.ok(new JwtResponse(jwt, signinDTO.getUsername()));
    }
